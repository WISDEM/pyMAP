...
"""
  NOTE: this example is not ready in pyMAP
...
# from pyMAP.fast_driver_support import *
# from pyMAP.mapsys import *
from pymap import pyMAP

raise NotImplementedError('This fast_driver is not fully implemented in pyMAP')
...
if __name__ == '__main__':      
    ...
    mooring.summary_file('_barge.sum.txt')
    mooring.init()
